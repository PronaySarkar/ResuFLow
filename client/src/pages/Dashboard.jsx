      ...
      <div className="max-w-7x1 mx-auto px-4 py-8">
          ...
          {allResumes.map((resume, index) => {
            ...
            return (
              ...
              >
                ...
                <p
                  className="absulate bottom-1 text-[11px] text-slate-400 group-hover:text-slate-500 transition-all duration-300 px-2 text-center"
        ...
        {showCreateResume && (
          ...
          >
            ...
            >
              <h2 className="text-x1 font-bold mb-4">Create a Resume</h2>
              <input
        ...
        {showUploadResume && (
          ...
          >
            <div
              ...
              className="relative bg-slate-50 border shadow-md rounded-lg w-full max-w-sm p-6"
            >
              <h2 className="text-x1 font-bold mb-4">Upload Resume</h2>
              <input
                onChange={(e) => setTitle(e.target.value)}
                value={title}
                type="text"
        ...
        {editResumeId && (
          ...
          >
            <div
              ...
              className="relative bg-slate-50 border shadow-md rounded-lg w-full max-w-sm p-6"
            >
              <h2 className="text-x1 font-bold mb-4">Edit Resume Title</h2>
              <input
                onChange={(e) => setTitle(e.target.value)}
                value={title}
                type="text"
